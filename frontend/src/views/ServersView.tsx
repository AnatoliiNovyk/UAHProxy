...
import { Server as ServerIcon, Plus, Terminal, CheckCircle2, Shield, AlertCircle, Key } from 'lucide-react';
              ...
              <tr key={s.id} className="hover:bg-gray-800/30 transition">
                ...
                <td className="p-4">
                  {testResult && testResult.id === s.id ? (
                    ...
                    <span className="inline-flex items-center space-x-1 text-xs text-emerald-400 font-mono">
                ...
                <td className="p-4 text-right">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-gray-800 hover:bg-gray-700 text-xs font-medium text-cyan-300 border border-gray-700 transition flex items-center space-x-1 ml-auto"
                  >
                    <Terminal className="w-3.5 h-3.5" />
                    <span>{testingId === s.id ? 'Testing...' : t.test_ssh}</span>
                  </button>
                </td>
              </tr>
            ))}
            ...
            <form onSubmit={handleAddServer} className="space-y-3">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="lb-secondary-02.local"
                  value={hostname}
